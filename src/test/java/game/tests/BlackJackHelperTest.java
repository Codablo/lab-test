...
public class BlackJackHelperTest {
    ...
    public void deck_is_shuffled_and_each_player_is_dealt_to_in_order() throws OutOfCardsError {
        ...
        BlackJackHelper.initGame(mockedHumanPlayer, mockedBotPlayer, mockedDeck);
    ...
    public void human_is_dealt_to_until_stay() throws OutOfCardsError {
        ...
        for (int i = 0; i < 3; i++) {
            BlackJackHelper.dealToHuman(mockedHumanPlayer, mockedBotPlayer, mockedDeck);
        }
    ...
    public void bot_is_dealt_to_until_stay() throws OutOfCardsError {
        ...
        for (int i = 0; i < 3; i++) {
            BlackJackHelper.dealToBot(mockedHumanPlayer, mockedBotPlayer, mockedDeck);
        }
    ...
    public void outcome_is_bot_when_human_is_busted() {
        ...
        outcome = BlackJackHelper.getOutcome(mockedHumanPlayer, mockedBotPlayer, Action.Busted, Action.Stay);
    ...
    public void outcome_is_human_when_bot_is_busted_and_human_is_not() {
        ...
        outcome = BlackJackHelper.getOutcome(mockedHumanPlayer, mockedBotPlayer, Action.Stay, Action.Busted);
    ...
    public void outcome_is_displayed() {
        ...
        BlackJackHelper.displayGameResults(mockedHumanPlayer, mockedBotPlayer, Outcome.Human);
    ...
    public void each_players_score_is_displayed_when_the_game_is_over() {
        ...
        BlackJackHelper.displayGameResults(mockedHumanPlayer, mockedBotPlayer, Outcome.None);
